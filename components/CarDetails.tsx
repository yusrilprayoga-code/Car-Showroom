  ...
  return (
    ...
    <Transition appear show={isOpen} as={Fragment}>
        <Dialog as='div' className="relative z-10" onClose={closeModal}>
            ...
            >
                <Dialog.Panel className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto transform rounded-2xl bg-white p-6 text-left shadow-xsl gap-5 transition-all flex flex-col">
                    ...
                    <div className='flex-1 flex flex-col gap-3'>
                        <div className='relative w-full bg-pattern bg-cover bg-center rounded-lg h-40'>
